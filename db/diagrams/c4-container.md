# ReconX — C4 Container Architecture Documentation

This document describes the **C4 Container level architecture** for **ReconX**, an enterprise trade reconciliation system.
