...
C4Context
    ...
    System_Ext(sftp, "Counterparty Trade Files", "EOD CSV feeds from custodian/counterparties via SFTP.")
    ...
    %% Relationships - Personas to ReconX
    ...
    %% Relationships - External Systems to ReconX
    Rel(oms, reconx, "Streams trade events", "Kafka topic")
    Rel(sftp, reconx, "Drops EOD trade CSVs", "SFTP, SSH Key")
