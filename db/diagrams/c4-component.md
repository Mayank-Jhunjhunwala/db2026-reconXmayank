...
This diagram illustrates the internal component architecture of the `recon-service API` container, including its controllers, security filters, business services, repositories, and messaging adapters.
